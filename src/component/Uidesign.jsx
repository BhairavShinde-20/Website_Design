...
<div className='mai-formgrp' >
        ...
        <main>
            <div className="content_left">
                <h3>Welcome to... </h3>
                <h2>Senwell Solutions.</h2>
                <p>Experiment with new technologies and try out new workflows and processes. There is always a way to improve your
                productivity, quality and internal processes, leading to a lower lead time and faster business growth.</p>
             <button className="hire"  onClick={handleShow}>Hire Now</button>
            </div>
            <div className="content_right">
                <img src={Ui} alt="" className='hero_img' />
            </div>
